...
| [aws_iam_role.packer_gitlab](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
...
| [aws_iam_role_policy.packer_gitlab](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
...
| [aws_iam_policy_document.packer_gitlab_assume](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_oidc_gitlab_aud_value"></a> [oidc\_gitlab\_aud\_value](#input\_oidc\_gitlab\_aud\_value) | n/a | `string` | `"https://gitlab.com"` | no |
| <a name="input_oidc_gitlab_match_field"></a> [oidc\_gitlab\_match\_field](#input\_oidc\_gitlab\_match\_field) | n/a | `string` | `"sub"` | no |
| <a name="input_oidc_gitlab_match_value"></a> [oidc\_gitlab\_match\_value](#input\_oidc\_gitlab\_match\_value) | n/a | `list(any)` | n/a | yes |
...
| <a name="output_packer_gitlab_role_arn"></a> [packer\_gitlab\_role\_arn](#output\_packer\_gitlab\_role\_arn) | The ARN of the Packer role that can be assumed by the CI user |
